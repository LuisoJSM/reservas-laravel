    ...
    <div class="p-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg m-2 mt-5">
        <div class="flex items-center justify-around">
            ...
            <div class="text-center">
                <h2 class="text-lg text-gray-900 dark:text-white font-semibold mb-2">
                    {{ $business->name }}
                </h2>
            </div>
        ...
        @foreach ($business->slots as $slot)
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <p class="text-sm {{ $slot->isBooked() ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                        @if($slot->isBooked())
                            @if($slot->isMyBooking())
                                Reservado por mí
                            @else
